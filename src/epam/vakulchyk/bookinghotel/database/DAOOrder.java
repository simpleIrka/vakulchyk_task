...
public class DAOOrder extends DAO<Order> {
    ...
    public ArrayList<Order> takeAllOrder() throws SQLException {
        ...
        String sql = "SELECT * FROM bookinghotel.order";
...
public boolean create(int numberSeats,int idClient,String typeApartment,int timeStay,String dateArrival)throws SQLException{
    ...
    String sql = "INSERT INTO bookinghotel.order (number_of_seats, type_of_apartment, time_of_stay, data_of_arrival, id_client) VALUE (?,?,?,?,?)";
    ...
    public int takeTimeStay(int id) throws SQLException{
        ...
        String sql = "select id_order,time_of_stay from bookinghotel.order where id_order=" + id;
        PreparedStatement preparedStatement = null;
        preparedStatement = connection.prepareStatement(sql);
    ...
    public ArrayList<Order> orederClient(long id) throws SQLException {
        ArrayList<Order> list = new ArrayList<>();
        String sql = "SELECT number_of_seats,type_of_apartment,time_of_stay,data_of_arrival,id_client FROM bookinghotel.order WHERE id_client = " + id;
